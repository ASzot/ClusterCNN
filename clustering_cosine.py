...
def custom_kmeans(X, ncluster, distance_metric):
    """
    :param distance_metric: Any distance metric in scipi.spatial.distance is valid.
    ...
    if kmsample > 0:
        centres, xtoc, dist = kmeanssample( X, ncluster, nsample=kmsample,
            delta=kmdelta, maxiter=kmiter, metric=distance_metric, verbose=1 )
    else:
